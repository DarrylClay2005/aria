...
class AdvancedAdmin(commands.Cog):
    ...
    @app_commands.command(name="emergency_lockdown", description="[OWNER] Locks down ALL channels in the server instantly")
    ...
    @app_commands.command(name="unlock_all", description="[OWNER] Unlocks all previously locked channels")
    @app_commands.default_permissions(administrator=True)
    ...
    # --- MASS MODERATION ---
    @app_commands.command(name="mass_ban", description="[OWNER] Ban multiple users at once (Separate IDs by spaces)")
    @app_commands.default_permissions(administrator=True)
    ...
    # --- AUTOMATION & STATS ---
    @app_commands.command(name="schedule_message", description="[OWNER] Schedule a message to be sent after a delay")
    ...
    @app_commands.command(name="server_stats", description="[OWNER] Get comprehensive server statistics")
    @app_commands.default_permissions(administrator=True)
